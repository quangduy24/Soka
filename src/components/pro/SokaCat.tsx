...
export const SokaCat: React.FC<SokaCatProps> = ({ size = 120, className = '' }) => (
  <div className={`inline-block ${className}`} style={{ width: size, height: size * 1.4 }}>
    <svg viewBox="0 0 200 280" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-lg">
      ...
      {/* Black collar with gold hexagonal pendant */}
      <rect x="86" y="135" width="28" height="6" rx="3" fill="#1a1a2e" />
      <polygon points="100,140 106,144 106,152 100,156 94,152 94,144" fill="#FFD700" stroke="#1a1a2e" strokeWidth="1.5" />
      ...
      {/* Eyes - half-lidded confident with eyelashes */}
      <g>
      ...
      {/* Mouth - subtle smug smile */}
      <path d="M92 100 Q100 106 108 100" stroke="#1a1a2e" strokeWidth="2" fill="none" strokeLinecap="round" />

      {/* Right arm - pointing up with attitude */}
      <path d="M125 145 C140 135, 150 115, 145 95" stroke="url(#furGrad)" strokeWidth="14" strokeLinecap="round" fill="none" />
      <path d="M125 145 C140 135, 150 115, 145 95" stroke="#1a1a2e" strokeWidth="3" strokeLinecap="round" fill="none" />

      {/* Right glove - white cartoon glove */}
      <ellipse cx="142" cy="87" rx="14" ry="12" fill="white" stroke="#1a1a2e" strokeWidth="3" />
      <rect x="132" y="77" width="20" height="8" rx="3" fill="white" stroke="#1a1a2e" strokeWidth="2" />
      {/* Pointing finger */}
      <path d="M142 75 L142 63" stroke="white" strokeWidth="6" strokeLinecap="round" />
      <path d="M142 75 L142 63" stroke="#1a1a2e" strokeWidth="2" strokeLinecap="round" />

      {/* Left arm - on hip */}
      <path d="M75 145 C60 150, 55 165, 60 175" stroke="url(#furGrad)" strokeWidth="14" strokeLinecap="round" fill="none" />
      <path d="M75 145 C60 150, 55 165, 60 175" stroke="#1a1a2e" strokeWidth="3" strokeLinecap="round" fill="none" />

      {/* Left glove */}
      <ellipse cx="58" cy="180" rx="13" ry="11" fill="white" stroke="#1a1a2e" strokeWidth="3" />
      <rect x="49" y="172" width="18" height="7" rx="3" fill="white" stroke="#1a1a2e" strokeWidth="2" />
      ...
      {/* Shoes - pink with white pointed toes */}
      ...
      {/* Cel-shading under feet */}
      <ellipse cx="82" cy="275" rx="15" ry="4" fill="#1a1a2e" opacity="0.15" />
      <ellipse cx="118" cy="275" rx="15" ry="4" fill="#1a1a2e" opacity="0.15" />
    </svg>
  </div>
);
